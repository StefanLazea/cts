...
public class Produs {
	...
	public int getVanzareMaxima() throws MaxException {
		if(vanzariZilnice != null) {
			int maxim = vanzariZilnice.get(0);
	...
	// actualizeaza stocul prin comanda furnizor - la stocul existent se adauga
	// cantitatea comandata
	// daca furnizorul nu are produse pe stoc atunci se arunca exceptie de tip
